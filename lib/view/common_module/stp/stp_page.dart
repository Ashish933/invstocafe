...
import 'package:investocafe_flutter/view/common_module/stp/stp_auto_trans_page.dart';
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            InkWell(
                              onTap: (){
                                goNextScreen(to: const STPAutoTransferPage(),side: PageTransitionType.rightToLeft);
                              },
                              child: Container(
                                width: getWidth(300),
