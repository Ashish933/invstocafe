...
class OtherFundsPage extends StatefulWidget {
  const OtherFundsPage({Key? key}) : super(key: key);

  @override
  State<OtherFundsPage> createState() => _OtherFundsPageState();
}

class _OtherFundsPageState extends State<OtherFundsPage> {
                ...
                child: Column(
                  ...
                  children: AnimationConfiguration.toStaggeredList(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          UtilityWidgets.MainText("Other Performing Funds",
