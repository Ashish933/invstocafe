...
class ChildrenMarriage extends StatefulWidget {
  const ChildrenMarriage({super.key});

  @override
  _ChildrenMarriageState createState() => _ChildrenMarriageState();
}

class _ChildrenMarriageState extends State<ChildrenMarriage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: AnimationConfiguration.toStaggeredList(
                      ...
                      children: [
                        boxHeight(20),
                        UtilityWidgets.MainText("Wedding cost in today's value (Rs.)",
                        ...
                        UtilityWidgets.MainText("Number of year to reach goal",
                            size: 11.sp, color: AppColors.titleText),
                        boxHeight(5),
                        CustomDropdown(
                        ...
                        UtilityWidgets.MainText("Expected return on saving(%)",
                            size: 11.sp, color: AppColors.titleText),
                        boxHeight(5),
                        CustomDropdown(
