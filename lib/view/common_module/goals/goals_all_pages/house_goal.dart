...
class HouseGoal extends StatefulWidget {
  const HouseGoal({super.key});

  @override
  _HouseGoalState createState() => _HouseGoalState();
}

class _HouseGoalState extends State<HouseGoal> {
