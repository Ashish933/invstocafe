...
class ForeignTourGoal extends StatefulWidget {
  const ForeignTourGoal({super.key});

  @override
  _ForeignTourGoalState createState() => _ForeignTourGoalState();
}

class _ForeignTourGoalState extends State<ForeignTourGoal> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: AnimationConfiguration.toStaggeredList(
                      ...
                      children: [
                        boxHeight(20),
                        UtilityWidgets.MainText(" Total cost in today's value (Rs.)",
                        ...
                        UtilityWidgets.MainText("Expected return on savings(%)",
                            size: 11.sp, color: AppColors.titleText),
                        boxHeight(5),
                        CustomDropdown(
