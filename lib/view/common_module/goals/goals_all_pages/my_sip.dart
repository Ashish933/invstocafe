...
class MySIPGoal extends StatefulWidget {
  const MySIPGoal({super.key});

  @override
  _MySIPGoalState createState() => _MySIPGoalState();
}

class _MySIPGoalState extends State<MySIPGoal> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: AnimationConfiguration.toStaggeredList(
                      ...
                      children: [
                        boxHeight(20),
                        UtilityWidgets.MainText("I am able to invest every month(Rs.)",
                        ...
                        boxHeight(15),
                        UtilityWidgets.MainText("I can invite for(months)",
                            size: 11.sp, color: AppColors.titleText),
                        boxHeight(5),
                        UtilityWidgets.inputField(
                          inputType: TextInputType.number,
