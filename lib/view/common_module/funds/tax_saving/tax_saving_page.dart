...
import '../../category_pages/equity/cancel_modify_page.dart';
import '../equity/long_term_popup.dart';

class TaxSavingPage extends StatefulWidget {
  const TaxSavingPage({Key? key}) : super(key: key);

  @override
  State<TaxSavingPage> createState() => _TaxSavingPageState();
}

class _TaxSavingPageState extends State<TaxSavingPage> {
                ...
                child: Column(
                  ...
                  children: AnimationConfiguration.toStaggeredList(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          UtilityWidgets.MainText("Save upto Rs 46,350 under section 80c",
                      ...
                      boxHeight(50),
                      CustomButton.button("BEGIN INVESTING",
                          size: 10.sp, callBack: () {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: CustomButton.button(
                                  ...
                                  callBack: () {
                                    goNextScreen(to: CancelModifyPage(),side: PageTransitionType.rightToLeft);
                                  })),
                        ],
                      ),
                      boxHeight(10),
