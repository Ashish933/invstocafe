...
class SIPInsurePage extends StatefulWidget {
  const SIPInsurePage({Key? key}) : super(key: key);

  @override
  State<SIPInsurePage> createState() => _SIPInsurePageState();
}

class _SIPInsurePageState extends State<SIPInsurePage> {
                ...
                child: Column(
                  ...
                  children: AnimationConfiguration.toStaggeredList(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          UtilityWidgets.MainText("Long term investments with Insurance",
                      ...
                      boxHeight(20),
                      UtilityWidgets.MainText("Rs.1800.4",
